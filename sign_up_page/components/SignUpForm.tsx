    ...
    <div className="min-h-screen bg-[#fefcf7] flex flex-col items-center font-sans">
      ...
      <main className="w-full max-w-md px-6 py-8 flex flex-col flex-grow">
        <div className="text-center mb-8">
          ...
          <hr className="border-none h-[1px] bg-[linear-gradient(to_bottom,#EAE1E1_0%,#DBBC47_98%,#EAE1E1_100%)] mt-4 w-full" />{" "}
          <hr className="border-t border-[#000000]-200 mt-4 w-full" />
        </div>
